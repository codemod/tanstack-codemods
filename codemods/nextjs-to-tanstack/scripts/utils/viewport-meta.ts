...
export function viewportObjectToMetaParts<T extends TypesMap>(objTyped: SgNode<T>): ViewportMetaParts {
...
function buildViewportContent(layoutPairs: Map<string, AnyNode>, unmapped: string[]): string {
    ...
    switch (key) {
      ...
      case 'initialScale': {
        ...
        if (n !== null) {
          ...
          unmapped.push('viewport.initialScale (non-literal)')
        }
        break
      }
      case 'minimumScale': {
        ...
        if (n !== null) {
          ...
          unmapped.push('viewport.minimumScale (non-literal)')
        }
        break
      }
      case 'maximumScale': {
        ...
        if (n !== null) {
          ...
          unmapped.push('viewport.maximumScale (non-literal)')
        }
        break
      }
      case 'userScalable': {
        ...
        if (b !== null) {
          ...
          unmapped.push('viewport.userScalable (non-literal)')
        }
        break
      }
      case 'viewportFit': {
        ...
        if (s !== null) {
          ...
          unmapped.push('viewport.viewportFit (non-literal)')
        }
        break
      }
      case 'interactiveWidget': {
        ...
        if (s !== null) {
          ...
          unmapped.push('viewport.interactiveWidget (non-literal)')
        }
        break
      }
      default: {
  ...
  if (height !== null && height !== undefined) {
    segments.push(`height=${height}`)
  }
  segments.push(`initial-scale=${initialScale ?? 1}`)
  if (minimumScale !== null && minimumScale !== undefined) {
    segments.push(`minimum-scale=${minimumScale}`)
  }
  if (maximumScale !== null && maximumScale !== undefined) {
    segments.push(`maximum-scale=${maximumScale}`)
  }
  if (userScalable === false) {
    segments.push('user-scalable=no')
  }
  if (userScalable === true) {
    segments.push('user-scalable=yes')
  }
  if (viewportFit !== null && viewportFit !== undefined) {
    segments.push(`viewport-fit=${viewportFit}`)
  }
  if (interactiveWidget !== null && interactiveWidget !== undefined) {
...
function pushThemeColor(metaItems: string[], desc: { color: string; media?: string }): void {
  if (desc.media !== null && desc.media !== undefined) {
    metaItems.push(
...
function readNumberLiteral(node: AnyNode): number | null {
  ...
  const t = node.text().replaceAll('_', '')
  const n = Number(t)
