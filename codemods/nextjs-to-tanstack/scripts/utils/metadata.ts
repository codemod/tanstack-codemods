...
export function isDynamicMetadata<T extends TypesMap>(node: SgNode<T>): boolean {
  ...
  if (n.is("function_declaration") || n.is("arrow_function")) return true;
  if (n.is("call_expression")) return true;
  return false;
}
